...
namespace CSharp_Basics
{
    ...
    public class DataTypesAndVariables
    {
        ...
        public void float_double_decimal()
        {
            ...
            decimal subtractdecimal = new decimal(X) - new decimal(Y);
            //decimal dividedecimal = new decimal(X) / new decimal(Y);
            decimal multiplydecimal = new decimal(X) * new decimal(Y);

            Assert.AreEqual(add, 140000000000000000000000000.0010000000000000000000000008);
            Assert.AreEqual(add, adddecimal);
            Assert.AreEqual(subtract, subtractdecimal);
            //Assert.AreEqual(divide, dividedecimal);
            Assert.AreEqual(multiply, multiplydecimal);
        }
        ...
        public void Default_Values()
        {
            ...
            Console.WriteLine("Zmienna typu int " + valInt);
            Console.WriteLine("Zmienna typu double " + valDouble);
            Console.WriteLine("Zmienna typu float " + valFloat);
            Console.WriteLine("Zmienna typu string " + valString);
            Console.WriteLine("Zmienna typu boolean " + valBoolean);
